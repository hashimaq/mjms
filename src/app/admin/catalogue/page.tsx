...
import { adminCategoryPath, SEASONS, SEASON_SLUGS } from "@/lib/collections/config";
  ...
  return (
    <div className="mjms-workspace-page mjms-workspace-page--catalogue">
      <WorkspacePageHeader
        ...
        actions={
          <>
            <Link href="/admin/search" className="mjms-btn mjms-btn-primary mjms-btn-md" prefetch>
              Search catalogue
            </Link>
            <Link href="/admin/products/new" className="mjms-btn mjms-btn-secondary mjms-btn-md" prefetch>
              Add product
            </Link>
          </>
        }
        ...
        {SEASON_SLUGS.map((seasonSlug, index) => {
          ...
          return (
            <section
              ...
              aria-labelledby={`admin-${seasonSlug}-heading`}
            >
              <div className="mjms-catalogue-season-head">
                <h2 id={`admin-${seasonSlug}-heading`} className="mjms-catalogue-season-title">
                  {season.title}
                </h2>
